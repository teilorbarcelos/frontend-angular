...
import { ProductCreationsChartComponent } from './product-creations-chart.component';
...
describe('ProductCreationsChartComponent', () => {
  let component: ProductCreationsChartComponent;
  let fixture: ComponentFixture<ProductCreationsChartComponent>;

  beforeEach(async () => {
    vi.spyOn(HTMLCanvasElement.prototype, 'getContext').mockReturnValue({} as any);

    await TestBed.configureTestingModule({
      imports: [ProductCreationsChartComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(ProductCreationsChartComponent);
