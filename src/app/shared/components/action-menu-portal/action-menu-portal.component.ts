  ...
  template: `
    @if (state(); as menu) {
      <div 
        ...
        [style.bottom.px]="menu.position.upwards ? (viewportHeight - menu.position.top + 4) : undefined"
      ...
      >
        <div class="bg-white border border-gray-200 rounded-lg shadow-2xl py-1 overflow-hidden">
          <ng-container [ngTemplateOutlet]="menu.template" [ngTemplateOutletContext]="menu.context"></ng-container>
        </div>
      </div>
